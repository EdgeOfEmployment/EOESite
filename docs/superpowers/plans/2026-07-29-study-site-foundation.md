...
**Note:** This plan requires a Supabase project. Before Task 2, the executing engineer (or the user) needs to create one at [https://supabase.com](https://supabase.com) and have the project URL + anon key ready.
...
- [x] **Step 2: Verify the app builds and runs**

Run: `npm run build`
Expected: Build completes with no errors (`Compiled successfully`).

- [x] **Step 3: Install testing dependencies**
...
- [x] **Step 5: Create the Vitest setup file**
...
- [x] **Step 7: Verify Vitest runs with no test files**
...
- [x] **Step 1: Install the Supabase packages**

```bash
npm install @supabase/supabase-js @supabase/ssr
```

- [x] **Step 2: Document required env vars**
...
- [x] **Step 3: Create the browser client**
...
- [x] **Step 4: Create the server client**
...
- [x] **Step 5: Create the middleware session helper**
...
- [x] **Step 3: Write the logout action**
...
- [x] **Step 4: Write the nav component**
...
- [x] **Step 4: Write the dashboard placeholder**
...
- [x] **Step 5: Write the app-shell layout**
...
- [x] **Step 7: Full test suite + build check**
...
- [x] **Step 3: Promote yourself to admin**
...
- [x] **Step 4: Confirm access after promotion**
...
- [x] **Step 5: Confirm admin page works**

Visit `http://localhost:3000/admin`.
Expected: Your own name appears under "멤버" with no 강퇴 button (since you're the admin).

- [x] **Step 6: Sign up a second test account and approve it**
...
- [x] **Step 7: Confirm non-admins are blocked from /admin**
